...
function buildSidebar() {
  ...
  if (currentUser.rol === 'supervisor' || currentUser.rol === 'admin') {
    ...
    html += '<a href="#" data-view="consolidado" onclick="cambiarVista(\'consolidado\',this)"><i class="fas fa-chart-bar"></i> Consolidado</a>';
    html += '<a href="#" data-view="asignar-actividad" onclick="cambiarVista(\'asignar-actividad\',this)"><i class="fas fa-plus-circle"></i> Asignar Actividad</a>';
    html += '<a href="#" data-view="monitoreo" onclick="cambiarVista(\'monitoreo\',this)"><i class="fas fa-tasks"></i> Monitoreo</a>';
